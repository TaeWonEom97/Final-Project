...
<body class="bg-primary" style="-bs-bg-opacity: .5;">
	...
	<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
		<!-- Navbar Brand-->
		<a class="navbar-brand ps-3" href="/"><i class="fas fa-home"></i>
			재고관리프로그램</a>
		<!-- Sidebar Toggle-->
									...
									<form action="/login" method="post">
										<div class="form-floating mb-3">
											<input class="form-control" id="username" name="username"
												type="email" placeholder="아이디" /> <label for="username">아이디(이메일
												형식)</label>
										</div>
										<div class="form-floating mb-3">
											<input class="form-control" id="password" name="password"
												type="password" placeholder="비밀번호" /> <label for="password">비밀번호</label>
										</div>
										...
										<div
											...
											<a href="javascript:void(0)"> <img width="150"
												height="33" src="../resources/assets/img/kakao_login.png" />
											</a>
