				...
				<div class="sb-sidenav-menu">
					<div class="nav">
						...
						<a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
							...
							<div class="sb-sidenav-collapse-ar">
						...
						<div class="collapse" id="collapseLayouts"
							...
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="/tables-1">입고관리</a> <a
									class="nav-link" href="/tables-2">판매관리</a> <a class="nav-link"
									href="/tables-4">재고현황 및 조회</a>
							</nav>
						</div>
						<a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
						...
						<div class="collapse" id="collapsePages"
							...
							<nav class="sb-sidenav-menu-nested nav accordion"
								...
								<a class="nav-link" href="login.html">로그인</a> <a
									class="nav-link" href="register.html">신규등록</a> <a
									class="nav-link" href="password.html">비밀번호찾기</a>
							</nav>
						</div>
		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					...
					<div class="card mb-4">
						<div class="card-body">재고현황 페이지입니다. 현재 재고수량을 열람하실 수 있으며,
							수정,삭제 및 조회가 가능합니다.</div>
					</div>
					<div class="card mb-4">
						<div class="card-header">
							<i class="fas fa-table me-1"></i> 현재 재고 수량
						</div>
						<div class="card-body">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<p>
								기간: <input type="text" id="datepicker">
							</p>
						</div>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-group">
								<label for="">상품 코드</label> <input type="text" name="sellcode"
									class="form-control" placeholder="상품 코드" />
							</div>
							<div class="form-group">
								<label for="">재고수량</label> <input type="text" name="sellnum"
									class="form-control" placeholder="수량" />
							</div>
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-warning" id="modalModifyBtn">수정</button>
							<button type="button" class="btn btn-primary"
								data-dismiss="modal" id="modalCloseBtn">닫기</button>
						</div>
					</div>
				</div>
			</div>
