...
values('P001',30,sysdate,seqid.nextval);

select * from insertitem;

insert into INSERTITEM(code, insertnum, insertdate, seqid) BOOKTBL
values('P001',50,sysdate,seqid.nextval) on duplicate key update insertnum = insertnum + insertnum;
